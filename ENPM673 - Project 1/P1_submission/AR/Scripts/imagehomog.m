...
%*@File imagehomog.m
%*@Author  Mike Brookes. Modified by Zejiang Zeng
%*@Copyright 2017.2-2017.5 University of Maryland, Zejiang Zeng (zzeng@terpmail.umd.edu)
%*@             Mike Brookes 2010-2012
%*@brief IMAGEHOMOG Apply a homography transformation to an image with bilinear interpolation
%*@param Inputs: im(ny,nx,nc)  input image (uint8)
 %        h(3,3)        homography
 %        m             mode string
